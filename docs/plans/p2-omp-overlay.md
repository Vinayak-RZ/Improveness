...
Source survey: [Lilian Weng, “Harness Engineering for Self-Improvement” (Jul 2026)](https://lilianweng.github.io/posts/2026-07-04-harness/). Seed harness: in-tree [oh-my-pi/](../../oh-my-pi/). P0+P1 overlay: [harness/omp/](../../harness/omp/).
...
- **Authority docs:** [docs/proposals/00–05](../proposals/00-architecture.md); [DECISIONS.md](../../DECISIONS.md) D5–D10; [KERNEL.md](../../harness/omp/KERNEL.md); [SURFACES.md](../../harness/omp/SURFACES.md); [oh-my-pi#7907](https://github.com/can1357/oh-my-pi/issues/7907); completed P0/P1 contract in [IMPLEMENTATION_PLAN.md](../../IMPLEMENTATION_PLAN.md)
...
| User approves this nawab plan | pending | Phase 0 | approval of this document |
...
**Hard rule:** no execution phase starts while “user approves this plan” is pending.
...
| Document | Path | Role |
|----------|------|------|
| This plan | `docs/plans/p2-omp-overlay.md` | Draft contract until approval |
| IMPLEMENTATION_PLAN | repo root | P0/P1 history until Phase 0 copies this file over it |
...
- Human promote remains the only path onto `overlay/.omp/` (D7, proposed D12).
...
- **P2 vs P3 split** — ship CI + bounded search + local runner now; park public TB2 / Spec Kit / required-live-smoke — **proposed D11** — cost, leakage (P5), and AHE “do not tune on the public set”
- **Search authority** — auto-apply vs stage+queue — **stage+queue (proposed D12)** — D7; #7907; Weng reward hacking
...
- [ ] IMPLEMENTATION_PLAN.md is this contract; D11 + D12 recorded
...
None blocking if the defaults in §11 stand:
...
Override before approval if you want a different split (see the TRADEOFF in the review message).
